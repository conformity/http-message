...
namespace Conformity\Http\Message\Test\Request;

use PHPUnit_Framework_TestCase as TestCase;
use Conformity\Http\Message\RelativeStream;
use Conformity\Http\Message\Request;
use Conformity\Http\Message\Request\Serializer;
...
class SerializerTest extends TestCase
{
    ...
    public function testCanDeserializeResponseWithMultipleHeadersOfSameName()
    {
        ...
        $this->assertInstanceOf('Conformity\Http\Message\Request', $request);
    ...
    public function testFromStreamStopsReadingAfterScanningHeader()
    {
        ...
        $this->assertInstanceOf('Conformity\Http\Message\RelativeStream', $stream->getBody());
    }
}
